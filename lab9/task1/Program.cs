...
namespace Task1
{
    class Program
    {
        ...
        {
            string pathToTickerFile = "C:\\Users\\kolob\\OneDrive\\Рабочий стол\\sem3\\laba9\\ticker.txt";
                ...
                try
                {
                    ...
                    lock (locker)
                    {
                        using (StreamWriter streamWriter =
                               new StreamWriter("C:\\Users\\kolob\\OneDrive\\Рабочий стол\\sem3\\laba9\\output.txt", true))
                        {
